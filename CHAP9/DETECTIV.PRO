...
domain(p1(A:B,C:D)) :- type(A,suspect),type(C,victim).
domain(p2(A:B,C:D)) :- type(A,suspect),type(C,victim).
domain(p3(A:B,C:D)) :- type(A,suspect),type(C,victim).
domain(p4(A:B,C:D)) :- type(A,suspect),type(C,victim).
domain(p5(A:B,C:D)) :- type(A,suspect),type(C,victim).
domain(p6(A:B,C:D)) :- type(A,suspect),type(C,victim).
domain(p7(A:B,C:D)) :- type(A,suspect),type(C,victim).
domain(p8(A:B,C:D)) :- type(A,suspect),type(C,alibi).
